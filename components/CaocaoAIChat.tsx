  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: 'caocao',
      content: '你好，我是您的智能助手，我的名字叫曹冲，我是一个轻量级多媒体工作站，可以基于我聪明的家族遗传大脑为您实现文本，文字，图片，视频创作，也可以以工作流的形式搭建多媒体融合的创作，更可以将您创建的工作流实现自动批量化生产。为了帮助更多的残疾人士，我还加装了语音，手势识别的三头六臂，我内置了72种能力可以模块化调用，更为重要的是我是个爱学习的人，如果您持续使用我一个月后您将看到我令你惊艳的贴心懂你。',
      timestamp: new Date(),
      type: 'system'
    }
  ]);
